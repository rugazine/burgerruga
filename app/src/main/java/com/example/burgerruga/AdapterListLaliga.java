...
public class AdapterListLaliga extends RecyclerView.Adapter<AdapterListLaliga.ViewHolder> {

    private List<DataItem> datalist;
    private Context context;
    private ItemClickListener mClickListener;

    public AdapterListLaliga(List<DataItem> datalist, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.recycler_view_row_laliga, parent, false);
