...
public class AdapterListScorer extends RecyclerView.Adapter<AdapterListScorer.ViewHolder> {

    private List<DataItem> datalist;
    private Context context;
    private ItemClickListener mClickListener;

    public AdapterListScorer(List<DataItem> datalist, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.recycler_view_row_scorer, parent, false);
